...
pub mod cognition {
    ...
    pub use multiframe::{
        ...
        CognitiveFlowField, CognitivePotentialField, CognitiveTopology, ConceptAnchor,
        ConceptFlowVector, ConsolidatedMemory, EnergyGradient, EnergyMinimizingTrajectory,
        EmergentConcept, FlowPrediction, FrameIterationResult, ManifoldDrift,
        ManifoldEvolutionTrace, MultiFrameCognition, MultiFrameConfig, MultiFrameIteration,
        MultiFrameReport, RegionFlowVector, StabilizationMetrics, StableSense,
        StabilityEnergy, TopologicalNeighborhood, TopologicalRegion, TopologyEvolutionStep,
        TopologyMetrics,
    };
